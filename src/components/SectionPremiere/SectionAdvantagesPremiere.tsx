    ...
    <section className="bg-white py-24 dark:bg-zinc-800">
      <div className="container px-5 xl:px-0">
        <TitlePages
          ...
          descriptionTitle="Assista aos jogos mais emocionantes com o Premiere incluso no seu plano. Partidas ao vivo, reprises e canais exclusivos para toda a família, onde e quando quiser."
          align="left"
        />
