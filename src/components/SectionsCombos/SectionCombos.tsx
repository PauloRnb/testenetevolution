...
// Carregamento dinâmico (Lazy load dos carrosséis com SSR desabilitado)
const EmblaCarouselPlans = dynamic(
  () => import("../SectionsHome/EmblaCarouselPlans"),
  {
    ssr: false,
    loading: () => (
      <div className="h-48 text-center text-zinc-500">Carregando planos...</div>
    ),
  },
);

const EmblaCarouselApps = dynamic(() => import("./EmblaCarouselApps"), {
  ssr: false,
  loading: () => (
    <div className="h-48 text-center text-zinc-500">
          ...
          <div className="flex h-full flex-col items-center justify-between gap-5 md:flex-row 32md:gap-8">
            ...
            <div className="flex flex-col gap-y-8 px-5 pt-12 md:px-0 md:pt-0">
              ...
              <div className="flex items-center justify-center gap-4 md:justify-start">
                <a
                  href="#"
                  className="select-none rounded border border-white bg-white px-4 py-1.5 text-lg font-medium text-blue-500 transition-colors hover:bg-transparent hover:text-white"
                >
                  ASSINE AGORA
                </a>
                <a
                  href="#"
                  className="select-none rounded border border-white bg-transparent px-4 py-1.5 text-lg font-medium text-white transition-colors hover:bg-white hover:text-blue-500"
                >
                  SABER MAIS
                </a>
              </div>
