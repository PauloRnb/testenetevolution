...
import {
  DotButton,
  useDotButton,
} from "../SectionsHome/Plans/EmblaCarouselDotButton";
import {
  PrevButton,
  NextButton,
  usePrevNextButtons,
} from "../SectionsHome/Plans/EmblaCarouselArrowButton";
...
const EmblaCarouselCompanies: React.FC<PropType> = ({ options }) => {
...
export default EmblaCarouselCompanies;
