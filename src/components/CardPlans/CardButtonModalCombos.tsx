...
export function CardButtonModalCombos({
  ...
  return (
    <a
      ...
      {...rest}
      className={twMerge(
        "flex items-center justify-center bg-orange-600 rounded h-8 text-white font-medium text-base hover:bg-orange-500 transition-colors duration-200 w-full focus:outline-none",
        rest.className
      )}
    >
      {text}
