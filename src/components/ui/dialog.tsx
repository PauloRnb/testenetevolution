  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          "fixed left-[50%] top-[50%] z-50 grid h-[18.6875rem] w-[20.9375rem] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] select-none gap-4 border border-zinc-300 bg-background bg-white p-6 shadow-lg duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%] data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%] dark:border-zinc-700 dark:bg-zinc-900 sm:max-w-lg sm:rounded-lg md:h-[21.125rem] md:w-[34.875rem]",
          className,
        )}
        {...props}
      >
