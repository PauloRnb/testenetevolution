...
const socialLinks = [
  ...
  { href: "#", icon: LiaFacebookF },
];

const cardLinks: CardLink[] = [
  { title: "Privacidade", href: "/Privacy", icon: ShieldAlert },
  {
    title: "Ajuda",
...
export function Footer() {
  const linkClasses =
    "max-w-fit text-lg font-medium text-zinc-600 transition-colors duration-200 hover:text-blue-700 focus:outline-none focus-visible:text-blue-500 dark:text-cyan-400 dark:hover:text-cyan-500 dark:focus-visible:text-cyan-500";
    ...
    <footer className="w-full min-w-[375px] overflow-x-hidden">
      <section className="flex flex-col border-t border-zinc-300 bg-white pt-8 dark:border-zinc-600 dark:bg-zinc-900">
        ...
        <div className="w-full bg-blue-700 dark:bg-zinc-900">
          <div className="container flex items-center justify-between p-5 xl:px-0">
            <ArrowTopButton />
        ...
        <div className="w-full bg-blue-700 dark:bg-zinc-900">
          <div className="container flex items-start justify-between px-5 py-8 xl:px-0">
